...
export const whatsappNumber = "5551984839800"

export default function Contact() {

  const instagramUser = "barbearia_do_minhoca" 
  const address = "R. Marco Polo, 880 - São Vicente, Gravataí - RS"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-xl font-bold group-hover:text-primary transition-colors">(51) 98483-9800</p>
                </div>
              </a>
          ...
          <div className="w-full lg:w-1/2 h-[450px] relative group">
            ...
            <div className="relative z-10 w-full h-full bg-zinc-900 overflow-hidden rounded-sm grayscale invert contrast-[0.9] hover:grayscale-0 transition-all duration-700">
               <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6915.883867640677!2d-51.02284532208247!3d-29.923573811649824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9519739f8139aa65%3A0xdf31fe18550647e1!2sBarbearia%20do%20minhoca!5e0!3m2!1spt-BR!2sbr!4v1770626480581!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
